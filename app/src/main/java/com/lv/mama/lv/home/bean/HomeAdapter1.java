...
public class HomeAdapter1 extends RecyclerView.Adapter<HomeAdapter1.MyViewHolder>{
    Context context;
    List<Mysup.DataBean.DefaultGoodsListBean> mDatas;

    public HomeAdapter1(List<Mysup.DataBean.DefaultGoodsListBean> mDatas, Context context) {
        this.mDatas = mDatas;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                context).inflate(R.layout.fr1buj2, parent,
                false));
        return holder;
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position)
    {
        ...
        ImageLoader.getInstance().displayImage(mDatas.get(position).getGoods_img(), holder.im);
